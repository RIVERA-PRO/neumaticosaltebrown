...
export default function Detail() {
    ...
    return (
        <div className="detail">
            ...
            <div className="detail-contain">
                ...
                <div className="textDetail">
                    ...
                    <table>
                        ...
                        <tr>
                            <td className="desc">Rodado</td>
                            <td>{producto.rodado}</td>
                        </tr>
                        <tr>
                            <td className="desc">Ancho</td>
                            <td>{producto.ancho}</td>
                        </tr>
                        <tr>
                            <td className="desc">Radial</td>
                            <td>{producto.radial}</td>
                        </tr>
            ...
            <TilteSection title="RELACIONADOS" more="Ver más" link="tienda-de-usados" />
            <Swiper
                effect={'coverflow'}
                grabCursor={true}
                slidesPerView={'auto'}
